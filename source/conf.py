...
html_theme_options = {
    ...
    'announcement': 'Geoinformatics Research Days 2026 has ended. Thank you to all presenters and participants! Stay tuned for updates on the 2027 event.', #to add urgent messages
    'switcher': {
            'json_url': json_url,
